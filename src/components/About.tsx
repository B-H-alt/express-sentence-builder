    ...
    <section className="py-20 px-4 bg-secondary-light">
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-16">
          <h2 className="font-inter font-bold text-3xl md:text-5xl mb-6">What is Smart PECS?</h2>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="bg-white rounded-2xl p-8 shadow-soft">
            ...
            <ul className="space-y-4 text-muted-foreground">
              ...
              <li className="flex items-start gap-3">
                <div className="w-2 h-2 bg-muted-foreground rounded-full mt-2 flex-shrink-0"></div>
                <span className="font-inter font-medium text-base">Fixed sentence structures</span>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-gradient-to-br from-secondary/10 to-primary/10 rounded-2xl p-8 shadow-medium border-2 border-secondary/20">
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="font-inter font-medium text-base text-foreground">AI-generated contextual images</span>
              </li>
              <li className="flex items-start gap-3">
                <Brain className="w-6 h-6 text-secondary mt-1 flex-shrink-0" />
                <span className="font-inter font-medium text-base text-foreground">Intelligent sentence construction</span>
              </li>
              <li className="flex items-start gap-3">
                <ImageIcon className="w-6 h-6 text-secondary mt-1 flex-shrink-0" />
                <span className="font-inter font-medium text-base text-foreground">Unlimited visual vocabulary</span>
              </li>
              <li className="flex items-start gap-3">
                <MessageSquare className="w-6 h-6 text-secondary mt-1 flex-shrink-0" />
                <span className="font-inter font-medium text-base text-foreground">Adaptive communication patterns</span>
              </li>
            </ul>
          </div>
        </div>
